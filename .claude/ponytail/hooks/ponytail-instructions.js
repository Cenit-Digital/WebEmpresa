...
// ponytail (vendored in-repo): hooks live in .claude/ponytail/hooks and the
// canonical skill lives in .claude/skills/ponytail so Claude Code discovers it
// as /ponytail. Upstream used one '..' (hooks sibling of skills); here it needs
// two. getFallbackInstructions() covers any miss, so the ruleset never goes dark.
